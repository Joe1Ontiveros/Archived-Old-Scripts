...
'''
depreciated old python calculator, pre-college, 
TODO: remake in better format/fix issues & UI

original repo from my old github: https://github.com/bolony21/Pyco-Calco/blob/main/CALC1.0.py
'''
