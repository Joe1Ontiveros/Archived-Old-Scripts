...
Archieved old python script from highschool, Code largely from a tutorial video on python with 
custom UI made using tkinter to take inputs/make using the converter easier

Original Github repo from old github acc: https://github.com/bolony21/ImageASCIIConvert

TODO: Update script/improve it, fix old bugs and use newer knowledge of python to make it alot better! 
